...
def loadImmediate(R1, n, R3):
    n = int(n)
    registerFile.write_register(R1, n)


def loadData(R1, R2, R3):
    a = registerFile.read_register(R2)
    a = dataMemory.read_data(a)
    registerFile.write_register(R1, a)

def storeData(R1, R2, R3):
    a = registerFile.read_register(R1)
    b = registerFile.read_register(R2)
    dataMemory.write_data(b, a)
